...
parser.add_argument('--score_list',  type=str,   default="/root/autodl-tmp/exp/Bi_ECAPA_TDNN_Add_CyclicLR_CNC2800/CNC_E_file_1w_Bi_ECAPA_TDNN_Add_CyclicLR_CNC2800_diff_score_28.txt")
parser.add_argument('--K',       type=int,   default=2000)
parser.add_argument('--model_path',  type=str,   default="/root/autodl-tmp/exp/Bi_ECAPA_TDNN_Add_CyclicLR_CNC2800/model/model_0028.model")
...
if args.eval == True:
	...
	EER, minDCF = s.eval_as_norm(eval_list = args.eval_list, eval_path = args.eval_path, \
								score_list = args.score_list, K = args.K)
